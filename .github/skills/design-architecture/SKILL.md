...
description: "根據需求規格書繪製 Sitemap、切分功能模組，並產出 SA（系統分析）與 SD（系統設計）文件。使用時機：完成需求分析後、開始開發前，需要確立系統架構、頁面結構、模組邊界與技術設計時。觸發關鍵字：繪製 sitemap、系統分析、系統設計、SA、SD、架構設計、模組切分、功能切分。"
